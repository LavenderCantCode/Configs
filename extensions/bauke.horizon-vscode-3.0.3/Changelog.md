...
* Made the line numbers and comments a little brighter.

## 3.0.2

Released on December 21st, 2019.

* Minor fixes to the repository and ReadMe, no functional changes.

## 3.0.1

Released on December 21st, 2019.

* Added the Horizon logo locally, this was preventing `vsce` from publishing.

## 3.0.0

Released on December 21st, 2019.

**The Horizon Theme was forked by [Bauke](https://bauke.xyz) after the [original theme's website](https://horizontheme.com) went down and the [repository](https://github.com/jolaleye/horizon-theme-vscode) was archived.**

* A new website has been made, available at [horizon.gitlab.io](https://horizon.gitlab.io).
* Renamed the "bright" theme to "light".
* The bold and italic variations of the theme have been removed.
* Updated the code preview samples to use FizzBuzz solutions from [rosettacode.org](https://rosettacode.org).
* Updated the Contributor Covenant Code of Conduct to use the latest version.
* Reorganized the repository, changed directory structures and informational filenames.
* Converted the theme creation to use one script for both light and dark variants.

---

The changelog before the fork, this includes broken links and links to jolaleye's GitHub repository and is kept for posterity.
